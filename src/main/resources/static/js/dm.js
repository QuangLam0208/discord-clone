const DM = (() => {
  ...
  async function executeSendMessage(receiverId, content, attachments = [], replyToId = null, existingTempId = null) {
      ...
      if (!existingTempId) DMUI.appendMessage(tempMsg, st.currentUserId, null, avatarMap, st.activeFriendName);
      ...
      try {
        ...
        st.pendingRetries.set(tempId, { receiverId, content, attachments, replyToId });
      }
    }
