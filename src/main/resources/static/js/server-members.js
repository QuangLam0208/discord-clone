        ...
        tr.innerHTML = `
            ...
            <td style="text-align: right;">
                <div style="position: relative; display: inline-block;">
                     ...
                     <div id="member-ctx-menu-${m.user.id}" class="ban-context-menu" style="display: none; position: absolute; right: 0; top: 100%; background: #111214; border-radius: 4px; padding: 6px; z-index: 100; width: 160px; box-shadow: 0 8px 16px rgba(0,0,0,0.24); text-align: left;">
                        <div class="ctx-item-red" onclick="confirmKickMember(${m.user.id})" style="padding: 8px; cursor: pointer; color: #f23f42; font-size: 14px; border-radius: 2px;">
                            <i class="fas fa-user-minus" style="margin-right: 8px;"></i> Đuổi thành viên
                        </div>
                        <div class="ctx-item-red" onclick="confirmBanMember(${m.user.id})" style="padding: 8px; cursor: pointer; color: #f23f42; font-size: 14px; border-radius: 2px;">
